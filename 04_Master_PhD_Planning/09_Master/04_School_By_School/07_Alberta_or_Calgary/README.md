## 1. School Name
University of Alberta or University of Calgary (not yet decided)
...
Needs official verification. Note: Alberta vs Calgary still needs to be decided.

## 8. Next Action
Confirm official admission requirements from the program's official page (Layer 1) for both schools, then verify faculty research areas and current supervision status via the official faculty directory (Layer 2) before deciding which school to pursue.
